...
import './mapPagePopup.css'

function MapPagePopup({ isOpen, onClose,agencyname, contactNumber,email,address,pin,state }) {
  ...
  return (
    <Popup className="trpop01" open={isOpen} onClose={onClose}>
      <div className="trdiv01">
        ...
        <p className="trdetails01">Pin Code: {pin}</p>
